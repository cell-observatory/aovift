...
# docker buildx build . --tag ghcr.io/cell-observatory/aovift:main_tf_cuda_12_3 --build-arg BRANCH_NAME=$(git branch --show-current) --target tf_cuda_12_3 --progress=plain --no-cache-filter pip_install
#
...
# Pass in a target when building to choose the Image with the version you want: --build-arg BRANCH_NAME=$(git branch --show-current) --target tf_cuda_12_3
# For github actions, this is how we will build multiple docker images.
# https://docs.nvidia.com/deeplearning/frameworks/support-matrix/index.html

# for CUDA 12.x
FROM nvcr.io/nvidia/tensorflow:24.02-tf2-py3 as base
...
FROM pip_install AS tf_cuda_12_3
