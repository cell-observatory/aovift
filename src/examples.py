...
repo = Path('~/Github/aovift/')
script = repo/'src/ao.py'

if platform.system() == "Windows":
    import win32api  # pip install pywin32
    python  = Path('python.exe')    # Where to find python
    repo    = r'C:\SPIM\Common\Calculations\Python\Phase Retrieval ML\aovift'  # Top folder of repo (path with spaces still fails.
...
model = repo/'pretrained_models/aovift-15-YuMB-lambda510.h5'
