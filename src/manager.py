...
def parse_args(args):
    ...
    slurm.add_argument(
        "--outdir", default='/clusterfs/nvme/thayer/aovift/models', type=str,
    ...
    lsf.add_argument(
        "--outdir", default='/groups/betzig/betziglab/thayer/aovift/models', type=str,
        help='output directory'
    )
    ...
    default.add_argument(
        "--outdir", default=f'{Path.home()}/aovift/models', type=str,
        help='output directory'
    )
...
def main(args=None):
    ...
    if args.cmd == 'local':
        ...
        docker_job += f" -v {Path.cwd().parent}:/app/aovift -w /app/aovift/src "
