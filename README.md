...
```shell
apptainer build --nv --force main_torch_cuda_12_8.sif docker-daemon:ghcr.io/cell-observatory/aovift:main_tf_cuda_12_3
```
**Note:** You need to replace `docker-daemon` with your local docker image path.
